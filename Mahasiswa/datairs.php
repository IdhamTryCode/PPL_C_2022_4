        ...
        <div class="card-body">
          ...
          <form method="POST" autocomplete="on" action="<?php echo htmlspecialchars(
            ...
            <div class="mb-3">
              ...
              <small class="form-text text-danger" id="semester_error"></small> -->
              <select name="status_irs" id="status_irs">
                <option value="0" <?php echo (($status_irs == 0) ? "selected=selected" : ""); ?>>Tidak Disetujui</option>
                <option value="1" <?php echo (($status_irs == 1) ? "selected=selected" : ""); ?>>Disetujui</option>
              </select>
            </div>
            <div class="mb-3">
